...
<div class="yf_008">
  <div class="yf_009">
    ...
    <a href="/#place-order">
      <div class="yf_012">易起起名网参考国学经典，易经、诗经、唐诗宋词著作起名</div></a>
  </div>
</div>
<!-- 头部结束 -->
     <meta name="renderer" content="webkit|ie-comp|ie-stand">
...
@media only screen and (max-width: 860px) {
		...
		.shengchent{display: none;}
            ...
            <li class="text"> <span>已有 9697889人选择易起起名网，好评率高达99.9%</span> </li>
          </ul>
        </form>
      </div>
    </div>
		...
		$(document).ready(function(){
			function xs(){
				...
				if(i == 36){
					...
					$(".jw").html(sj_index+ '分钟前　'+stxlwx+'下单了易起八字起名　<a href="/zhouyi32xb.php#main">点此下单</a>');	
					$(".jw").show();
					i = 0;
				}
				if(i == 18){
	  ...
	  <div style="text-align: center;">
		...
		<div class="l">
		  ...
		  <div class="hd" id="demoxj">
			<ul>
			  <li><span>订单号</span><span>2018*****5055 评论：</span></li>
			  <li>这家网站起名考虑得很全面，国学文化结合得很好，强烈推荐</li>
			  <li><span>订单号</span><span>2018*****2263 评论：</span></li>
			  <li>分析很专业，起到了很多好名字，目前还不知道选择哪个名字。</li>
			  <li><span>订单号</span><span>2018*****0123 评论：</span></li>
			  <li>朋友介绍过来的，果然是很棒的起名网站，起的名字很有内涵。</li>
			  <li><span>订单号</span><span>2018*****0189 评论：</span></li>
			  <li>这家起名网站很专业，帮我起了好多名字，最终选到了满意的好名字，</li>
			  <li><span>订单号</span><span>2018*****2565 评论：</span></li>
			  <li>不愧是中国权威的起名网站，起的名字很大气，好听又时尚。</li>
			  <li><span>订单号</span><span>2018*****2333 评论：</span></li>
			  <li>还不错，起的名字很满意，老公很喜欢，五星好评！</li>
			  <li><span>订单号</span><span>2018*****5562 评论：</span></li>
			  <li>大师起名很专业，强烈推荐，会介绍更多朋友过来的</li>
			  <li><span>订单号</span><span>2018*****2356 评论：</span></li>
			  <li>我哥推荐的，果然不负所望，名字非常满意，在此感谢大师付出。</li>
			  <li><span>订单号</span><span>2018*****5566 评论：</span></li>
			  <li> 宝宝出生，急需名字办理出生证，没想到这么快就起了名字给我选择</li>
			  <li><span>订单号</span><span>2018*****4489 评论：</span></li>
			  <li>名字很好，不俗气，听起来就很有气质！这家起名网站值得推荐</li>
			  <li><span>订单号</span><span>2018*****5689 评论：</span></li>
			  <li>起名很权威，好多名字都是出自楚辞诗经</li>
			  <li><span>订单号</span><span>2018*****1256 评论：</span></li>
			  <li>起到的好名字太多了，现在还没有确定选择哪个名字</li>
			  <li><span>订单号</span><span>2018*****8942 评论：</span></li>
			  <li>之前找了好几家都没有起到满意的名字，最后找宗秋山人老师起到了</li>
			  <li><span>订单号</span><span>2018*****2365 评论：</span></li>
			  <li>一个同事介绍来的，给宝宝取的 家人都满意 很专业</li>
			  <li><span>订单号</span><span>2018*****1256 评论：</span></li>
			  <li>师傅很有耐心，不厌其烦的帮我分析名字，服务态度值得称赞</li>
			  <li><span>订单号</span><span>2018*****5986 评论：</span></li>
			  <li>很不错，名字我们也很中意，谢谢了，会介绍给朋友的。</li>
			  <li><span>订单号</span><span>2018*****5698 评论：</span></li>
			  <li>起的名字很好，不俗气，也很清新，很有个性</li>
			  <li><span>订单号</span><span>2018*****2354 评论：</span></li>
			  <li>谢谢大师给我优先安排起名，从10个名字中选了两个,家人都很满意</li>
			  <li><span>订单号</span><span>2018*****0101 评论：</span></li>
			  <li>名字很时尚，很有内涵，不愧是老秀才，可以起这么多好名字</li>
			  <li><span>订单号</span><span>2018*****0145 评论：</span></li>
			  ...
			  <li><span>订单号</span><span>2018*****8942 评论：</span></li>
			  <li>之前找了好几家起名网站，最后找易起起名网起到满意的名字。</li>
			  <li><span>订单号</span><span>2018*****2365 评论：</span></li>
		...
		<div class="r">
		  ...
		  <div id="nxt">
			<ul>
			  ...
			  <li>易起起名 2018*****38084  *9.9元 </li>
			  <li>易起起名 2018*****23876  *9.9元 </li>
			  <li>易起起名 2018*****35087  *9.9元 </li>
			  <li>易起起名 2018*****23064  *9.9元 </li>
			  <li>易起起名 2018*****48211  *9.9元 </li>
			  <li>易起起名 2018*****21677  *9.9元 </li>
			  <li>易起起名 2018*****53868  *9.9元 </li>
			  <li>易起起名 2018*****48697  *9.9元 </li>
			  <li>易起起名 2018*****14973  *9.9元 </li>
			  <li>易起起名 2018*****17576  *9.9元 </li>
			  <li>易起起名 2018*****17827  *9.9元 </li>
			  <li>易起起名 2018*****17568  *9.9元 </li>
			  <li>易起起名 2018*****65615  *9.9元 </li>
			  <li>易起起名 2018*****68261  *9.9元 </li>
			  <li>易起起名 2018*****38046  *9.9元 </li>
			  <li>易起起名 2018*****23006  *9.9元 </li>
			  <li>易起起名 2018*****35087  *9.9元 </li>
			  <li>易起起名 2018*****23064  *9.9元 </li>
			  <li>易起起名 2018*****38084  *9.9元 </li>
			  <li>易起起名 2018*****23876  *9.9元 </li>
			  ...
			  <li>易起起名 2018*****38046  *9.9元 </li>
			  <li>易起起名 2018*****23006  *9.9元 </li>
			  <li>易起起名 2018*****35067  *9.9元 </li>
			  <li>易起起名 2018*****23068  *9.9元 </li>
			  <li>易起起名 2018*****38048  *9.9元 </li>
			  <li>易起起名 2018*****38046  *9.9元 </li>
			  <li>易起起名 2018*****17568  *9.9元 </li>
			  <li>易起起名 2018*****65615  *9.9元 </li>
			  <li>易起起名 2018*****68261  *9.9元 </li>
...
<div class="kefuzaixian">
  	<h2>咨询中心</h2>
  	<div class="qqbox">
  	  <a  href="http://wpa.qq.com/msgrd?v=3&uin=13609507&site=qq&menu=yes"><div class="qq">
  	  	 QQ咨询<br>
         13609507
  	  </div></a>
  	...
  	<div class="welchatimg">
  		<img src="https://qiniu.cdn.517900.com/FL97591.png">
  	</div>
